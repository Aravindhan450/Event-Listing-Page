...
export default function LiveChat({ viewerCount }: LiveChatProps) {
  ...
  return (
    <aside className="flex h-full min-h-0 max-h-full flex-col overflow-hidden rounded-xl border border-outline-variant/30 bg-surface-container-lowest">
      ...
      <div ref={messagesListRef} className="min-h-0 flex-1 overflow-y-auto px-3 py-2 space-y-4 [scrollbar-gutter:stable]">
